...
import numpy as np
from hist_equalization import perform_adaptive_equalization_transform, adaptive_hist_eq_no_interp, image_histogram, perform_global_hist_equalization, equalization_transform
#===================================================================================
...
#image file
filename = "test_images/test_image2.png"
img = Image.open(fp=filename)
#convert to gray scale
bw_image = img.convert("L")
#convert image to a numpy array of 8bit integers
